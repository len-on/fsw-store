...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("tailwind.config.tsflex tailwind.config.tsflex-col tailwind.config.tsspace-y-1.5 tailwind.config.tsp-6", className)}
    {...props}
  />
))
...
const CardContent = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("tailwind.config.tsp-6 tailwind.config.tspt-0", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("tailwind.config.tsflex tailwind.config.tsitems-center tailwind.config.tsp-6 tailwind.config.tspt-0", className)}
    {...props}
  />
))
